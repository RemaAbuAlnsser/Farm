...
export default function Login({ onLogin }) {
  ...
  return (
    <div style={{
      ...
      justifyContent: "center", background: "#f4f6f9", padding: "16px"
    }}>
      <div className="login-card" style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <h1 style={{ fontSize: "1.3rem", color: "#1a1a2e" }}>نظام إدارة المزرعة</h1>
          <p style={{ color: "#888", fontSize: "0.85rem", marginTop: 4 }}>سجّل دخولك للمتابعة</p>
        </div>
